...
class BaseNetwork(nn.Module):
    ...
    Output:
        none
    Description:
        Parent Class of EdgeConnect inpainting and edge generator networks.
    """
...
class EdgeGenerator(BaseNetwork):
    ...
    Output:
        none
    Description:
        EdgeGenerator network for Edge Connect model. Consists of 3 main parts.
            - encoder
            - middle
            - decoder
    """
...
class Discriminator(BaseNetwork):
    ...
    def __init__(
        self, in_channels=2, use_sigmoid=True, use_spectral_norm=True, init_weights=True
    ):
